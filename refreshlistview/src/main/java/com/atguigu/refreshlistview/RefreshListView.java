...
/**
 * Created by xinpengfei on 2016/10/19.
 * 微信:18091383534
 * Function :自定义带下拉刷新的ListView(自带记录上次刷新的时间)
 */
...
public class RefreshListView extends ListView {
    ...
    private void initFooterView(Context context) {
        ...
        footerView.setPadding(10, -footerViewHeight, 10, 10);
    ...
    private void initHeaderView(Context context) {
        ...
        pullDwonView.measure(0, 0);//测量控件的高(主要是调用其方法)
    ...
    /**
     * 判断是否完全显示顶部轮播图部分
     * 当ListView在Y轴的坐标小于或者等于顶部轮播图在Y轴坐标的时候，就完全显示
     *
     * @return
     */
...
//            }
    ...
    public void onFinishRefresh(boolean success) {
        ...
        if (isLoadMore) {
            ...
            //下拉刷新
            currentStatus = PULL_DOWN_REFRESH;
            progressbar.setPadding(0, -headerHeight, 0, 0);//把下拉刷新控件隐藏
