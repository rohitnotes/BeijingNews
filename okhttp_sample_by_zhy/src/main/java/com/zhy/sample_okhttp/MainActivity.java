...
//        String url = mBaseUrl + "user!postFile";
        String url = "http://192.168.12.165:8080/FileUpload/FileUploadServlet";
        OkHttpUtils
                .postFile()
                .url(url)
                .file(file)
...
//        File file = new File(Environment.getExternalStorageDirectory(), "messenger_01.png");
        File file = new File(Environment.getExternalStorageDirectory(), "1.png");//要上传文件在手机的目录
        if (!file.exists()) {
            Toast.makeText(MainActivity.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        }
...
//        String url = mBaseUrl + "user!uploadFile";
        String url = "http://192.168.12.28:8080/FileUpload/FileUploadServlet";

        OkHttpUtils.post()//
                .addFile("mFile", "1.png", file)//
                .url(url)//
                .params(params)//
                .headers(headers)//
                .build()//
...
//        String url = "https://github.com/hongyangAndroid/okhttp-utils/blob/master/okhttputils-2_4_1.jar?raw=true";
        String url = "http://192.168.12.28:8080/oppo.mp4";
        OkHttpUtils//
                .get()//
                .url(url)//
                .build()//
//                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath(), "gson-2.2.1.jar")//
                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath() + "/beijingnews/download/", "oppo.mp4")//
                {
